          ...
          <div className="max-w-[550px] mb-8">
            <div className="flex gap-2 mt-2">
              <input
                type="text"
                placeholder="Email"
                className=" px-4 py-2 border rounded-full text-gray-700 focus:outline-none focus:border-blue-500 w-[350px]"
              />
              <button
                onClick={handleOpenModal}
                className="rounded-full bg-orange-400 text-white px-4 font-Montserrat"
              >
                LET'S CONNECT
              </button>
            </div>

...
const SearchInput = ({searchInput, setSearchInput}) => {
  return (
    <article className="flex items-center shadow-[0px_4px_4px_0px_rgba(0,0,0,0.10)] mx-auto sm:max-w-[600px] mt-5 max-w-[358px] w-full h-[48px] sm:h-14 rounded-[57px]">
      ...
      <article className="sm:max-w-[180px] sm:w-full w-[110px] border-l border-light-grey bg-pastel-yellow rounded-r-[57px] h-full flex items-center py-4 pr-[15px]">
        <button
          type="submit"
          className="text-[#666] text-[10px] gap-5 sm:text-[13px] font-Montserrat font-normal leading-normal flex items-center justify-end text-center w-full"
        >
          <span className="  text-center">Surprise me</span>
          <SearchIcon />
        </button>
      </article>
    </article>
